...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency 'vcr', '~> 5.0.0' # SKIP WHEN COPYING TO TEMPLATE # rubocop:disable Metrics/LineLength
  s.add_development_dependency 'webmock', '~> 3.7.6' # SKIP WHEN COPYING TO TEMPLATE # rubocop:disable Metrics/LineLength
end
